...
from .locators import MainPageLocators, AboutMePageLocators, Links
...
class AboutMePage(BasePage):
    ...
    def should_be_about_me_text(self):
        try:
            self.browser.find_element(*AboutMePageLocators.ABOUT_ME_TEXT)
        except NoSuchElementException:
            assert False, "No ABOUT_ME_TEXT found"
